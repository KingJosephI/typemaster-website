...
const Features = () => {
  return (
    <section className={featuresStyles.features}>
      <article className={featuresStyles.card}>
        <div
          style={{
            background: "#F16718",
            width: "65px",
        ...
        >
          <img
            src={computerIcon}
            alt=""
            className={featuresStyles.card__image}
            style={{
              width: "25.14px",
              height: "20.24px",
            }}
        ...
        <h2 className={featuresStyles.card__title}>HIGHLY COMPATIBLE</h2>
        <p className={featuresStyles.card__description}>
      ...
      <article className={featuresStyles.card}>
        ...
        <h2 className={featuresStyles.card__title}>WIRELESS WITH BLUETOOTH</h2>
        <p className={featuresStyles.card__description}>
      ...
      <article className={featuresStyles.card}>
        ...
        <h2 className={featuresStyles.card__title}>HIGH CAPACITY BATTERY</h2>
        <p className={featuresStyles.card__description}>
      ...
      <article className={featuresStyles.card}>
        ...
        <h2 className={featuresStyles.card__title}>RGB BACKLIT MODES</h2>
        <p className={featuresStyles.card__description}>
